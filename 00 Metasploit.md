<h2 align="center">Metasploit</h2>
<p align="center"><img width="350" height="350" src="./src/metasploit.png"></p>
...
| `setg <PARAMETER_NAME VALUE>` | Set a specific value globally (for example, LHOST or RHOST). |
| `unsetg <PARAMETER_NAME>` | Clear any parameter value (for example, unsetg LHOST or unset all). |
